...
* \version 1.00
*
* This file provides App2 Core1 example source for the bootloader dual-app code example.
* App2 Core1 firmware does the following:
* - Turns on two LEDs
...
/*
* For usage with Cy_GPIO_Write(PIN_LED_2,0u) instead of Cy_GPIO_Write(GPIO_PRT13, 7u, 0u).
* Defines a LED pin's "port" and "pin number".
*/
#define PIN_LED_2    GPIO_PRT13, 7u
